...
# Load project
  ...
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -GWR_NR=$1 -GRD_NR=$2 -GWR_ORDER=$3 -GRD_ORDER=$4 -GTEST_NAME=$5 -GSEED_VAL=$6 -sva top
#dam drumul la simulare
